...
#We are taking a narrow view and not including meanFreq() and things like angles that 
#incorporate graivityMean into our selection.  Only mean() and std() features are included.
...
#the data frame is back to being wide, we will instead make it long 
#by again making each feature a variable option, instead of its own variable column
...
#it should have the number of activities (6) x the number of features (66) 
#added to the number of subjectIDs (30) x the number of features (66)
